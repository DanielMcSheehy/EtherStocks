...
class ContractContainer extends React.Component {
  ...
  render() {
   //console.log('bots', this.state.stockAddress['BOTS'].split('https://etherscan.io/address/')[1]);
    ...
    for(var key in this.state.stockAddress) {
          console.log(key,this.state.stockAddress[key].split('https://etherscan.io/address/')[1]);
    }
    return (
      <div>
        <ContractViewer stockName="BOTS" contractAddress={'0xc908a34165d2720d12ffcfb6b99b47161b1c9946'} />
      </div>
    );
  }
}
