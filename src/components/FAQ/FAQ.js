    ...
    return (
      <div className={s.root}>
        <div className={s.container}>
          ...
          <p> A.  No, there are no commissions or rake of any kind.  Each “Stock” is really its own smart contract, and they are all identical. The only fees would be the gas paid to send money through Metamask, you can read about this here (LINK)</p>
